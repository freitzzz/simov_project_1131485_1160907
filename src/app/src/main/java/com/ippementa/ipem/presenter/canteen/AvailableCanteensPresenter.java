...
public class AvailableCanteensPresenter implements IPresenter {
    ...
    public void requestRouteToCanteen(long schoolId, long canteenId) {

        RequestRouteToCanteenTask task = new RequestRouteToCanteenTask();

        RequestRouteToCanteenTask.TaskRequest request = task.new TaskRequest();
    ...
    private class RequestRouteToCanteenTask extends AsyncTask<RequestRouteToCanteenTask.TaskRequest, Integer, RequestRouteToCanteenTask.BackgroundResult> {
         ...
         */
        @Override
        protected BackgroundResult doInBackground(RequestRouteToCanteenTask.TaskRequest... requests) {
        ...
        protected void onPostExecute(BackgroundResult result) {
            ...
            if(presenter.isViewAvailableToInteract){
                ...
                if(result.ioException != null){
                    ...
                    presenter.view.navigateToRouteToCanteen(model);
